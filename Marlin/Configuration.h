 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 64, 80, 400, 925, 925 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE  100   // (mm/s) X and Y axes feedrate (also used for delta Z axis) // John Carlson change feedrate
